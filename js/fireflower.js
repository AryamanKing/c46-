(function() {
    ...
    var Fireflower = Mario.Fireflower = function(options) {
    ...
    Mario.Util.inherits(Fireflower, Mario.Floor);
  
    Fireflower.prototype.break = function() {
      sounds.breakFireflower.play();
      (new Mario.Rubble()).spawn(this.pos);
      var x = this.pos[0] / 16, y = this.pos[1] / 16;
      delete level.Fireflower[y][x];
    }
  
    Fireflower.prototype.bonk = function(power) {
      sounds.bump.play();
    ...
    Fireflower.prototype.update = function(dt, gameTime) {
      if (!this.standing) {
